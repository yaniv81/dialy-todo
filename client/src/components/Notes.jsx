                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {notes.map((note, index) => (
                            <div key={note._id} className="relative flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div className="flex-1 pl-4">
                                    <p className="text-gray-800 dark:text-gray-100 text-base whitespace-pre-wrap break-words leading-relaxed font-medium">
                                        {note.content}
                                    </p>
